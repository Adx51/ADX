...
export default function CampagneExport() {
  ...
  return (
    <div className="min-h-screen bg-white print:bg-white">
      ...
      {/* ── Contenu (toujours en mode clair) ── */}
...
function GroupeSection({ groupe, annee }) {
  ...
  return (
    <div className="print:break-inside-avoid">
      ...
      {/* ── Vue mobile : cards (toujours clair) ── */}
      ...
      {/* ── Vue desktop + impression : tableau (toujours clair) ── */}
      <table className="hidden md:table print:table w-full border-collapse text-sm">
        <thead>
          <tr className="border border-gray-400">
            ...
            <th className="border border-gray-400 px-3 py-2 text-center font-bold uppercase w-28 text-gray-900">Moyenne</th>
          </tr>
        </thead>
        <tbody>
...
function ParcelleTableRows({ parcelle }) {
  ...
  return (
    <>
      ...
      {hasMultiple && (
        <tr className="bg-amber-50 print-subtotal-row">
          <td className="border border-gray-300 px-3 py-1.5">
            <div className="flex items-center justify-between">
              <span className="text-xs font-bold text-gray-500 uppercase tracking-wide">Total</span>
