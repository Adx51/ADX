...
export default function BottomNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white/95 dark:bg-gray-900/97 backdrop-blur-sm border-t border-gray-100 dark:border-gray-800 z-20"
